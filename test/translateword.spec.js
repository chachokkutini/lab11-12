...
describe('Show translation.', () => {
  ...
  it('Should show translation.', async function () {

    const homePage = new HomePage(this.driver);
    await homePage.openPage();
    await homePage.clickTranslateButton();
    const translatePage = new TranslatePage(this.driver);
    expect(await translatePage.checkTranslationMessage()).to.contain(this.translateWordValue);                   
